...
class EWCTrainer:
    ...
    """
    def train_on_task(self, name, train_x, train_y, batch_epoch = 1):
    ...
    """
    def partial_fit(self, data_x1, data_y1,batch_epoch = 1):

        first_data=self.train_on_task("MNIST", data_x1, data_y1, batch_epoch)
